...
def fetch_stock_data(symbol, alpha_key=None):
    ...
    if "Time Series (Daily)" not in data:
        return None, data  # Return raw data if error
...
if st.button("Analyze"):
    ...
    if df is None:
        ...
        prompt = f"{question}The current price of {symbol} is {latest_price:.2f}.The 20-day SMA is {sma20:.2f} and the 50-day SMA is {sma50:.2f}. Provide a brief analysis based on this data."
